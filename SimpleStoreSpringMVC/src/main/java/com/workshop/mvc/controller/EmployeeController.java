...
public class EmployeeController {
  ...
  public String deleteAnEmployees() {
	  return "delete-employee-form";	    
  }
  
  @GetMapping("/processSingleDelete")
  public String deleteSingleEmployee(
...
//	Basically bila dah buat a process, update the model, baru benda tu reflect
//  the latest changes
	if (employeeToReturn == null) {
	      ...
	      return "display-single-employee";
	    	...
	    	employeeService.deleteEmployee(employeeToReturn);
	    }
